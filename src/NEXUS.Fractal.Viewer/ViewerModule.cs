using NEXUS.Fractal.Viewer.Views;
using Prism.Ioc;
using Prism.Modularity;
using Prism.Regions;

namespace NEXUS.Fractal.Viewer
{
    public class ViewerModule : IModule
    {
        public static string RegionName = "ViewerRegion";
        ...
        {
            regionManager.RegisterViewWithRegion<ViewerView>(RegionName);
        }
