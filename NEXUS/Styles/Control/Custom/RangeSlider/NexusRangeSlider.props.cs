...
public partial class NexusRangeSlider
{
    /// <summary>
    /// Defines the <see cref="Minimum"/> property
    /// </summary>
    public static readonly StyledProperty<double> MinimumProperty = 
        RangeBase.MinimumProperty.AddOwner<NexusRangeSlider>(
    ...
    public static readonly StyledProperty<double> MaximumProperty = 
        RangeBase.MaximumProperty.AddOwner<NexusRangeSlider>(
    ...
    public static readonly StyledProperty<double> RangeStartProperty = 
        AvaloniaProperty.Register<NexusRangeSlider, double>(nameof(RangeStart),
    ...
    public static readonly StyledProperty<double> RangeEndProperty = 
        AvaloniaProperty.Register<NexusRangeSlider, double>(nameof(RangeEnd), 
    ...
    public static readonly StyledProperty<double> StepFrequencyProperty = 
        AvaloniaProperty.Register<NexusRangeSlider, double>(nameof(StepFrequency), 
            defaultValue: 1);
    ...
    public static readonly StyledProperty<string> ToolTipStringFormatProperty =
        AvaloniaProperty.Register<NexusRangeSlider, string>(nameof(ToolTipStringFormat));

    /// <summary>
    /// Defines the <see cref="MinimumRange"/> property
    /// </summary>
    public static readonly StyledProperty<double> MinimumRangeProperty = 
        AvaloniaProperty.Register<NexusRangeSlider, double>(nameof(MinimumRange), defaultValue: 0d);
    ...
    public static readonly StyledProperty<bool> ShowValueToolTipProperty = 
        AvaloniaProperty.Register<NexusRangeSlider, bool>(nameof(ShowValueToolTip), defaultValue: true);
